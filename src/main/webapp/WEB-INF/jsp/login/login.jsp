...
<body>
	<div>
		<div class="CenterArea row">
			<form class="col-md-4 col-md-offset-4" method="post" action="${pageContext.request.contextPath}/login/loginAction_login.action" onsubmit="return checkSubmit();">
				<h3>协同OA系统</h3>
				...
				<button type="submit" class="btn btn-info">登录</button><label id="msg"><s:property value="msg"/></label>
			</form>
		</div>
	</div>
</body>
